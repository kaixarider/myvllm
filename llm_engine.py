#log_stats变量设置为True，直接输出了gpu，cpu使用率
#local_interval变量设置了输出数据的时间间隔
import time
...
class LLMEngine:
    ...
    def _get_stats(
        ...
        num_running_prefill=self.scheduler.get_running_prefill()
        # KV Cache Usage in %
        ...
        if  num_running_prefill!=0:
            Singleton.kv_cache=max(Singleton.kv_cache,num_total_gpu-num_free_gpu)
        '''
        # Iteration stats
