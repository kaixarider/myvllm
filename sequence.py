...
class SequenceGroup:
    ...
    def __init__(
        ...
        self.metrics = RequestMetrics(arrival_time=arrival_time,
                                      ...
                                      time_in_queue=None,first_decode_time=None)
        self.lora_request = lora_request
    ...
    def maybe_set_first_decode_time(self,time:float)->None:
        if self.metrics.first_decode_time is None:
            self.metrics.first_decode_time=time
