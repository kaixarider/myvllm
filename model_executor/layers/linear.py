...
import time,ray
from vllm.singleton import metricstype,parametertype
...
class ColumnParallelLinear(LinearBase):
    ...
    def forward(self, input_):
        ...
        if self.gather_output:
            ...
            finish_profile=ray.get(actor1.get_value.remote(parametertype.stop_profile))
            ...
            actor1=ray.get_actor("worker1")
            actor1.add_time.remote(end-start)
